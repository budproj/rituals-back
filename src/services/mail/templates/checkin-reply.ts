export const checkinReply = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html
...
>
  <head>
    ...
    <title>Novo comentário no seu check-in</title>
    <!--[if (mso 16)]>
      <style type="text/css">
        a {
  ...
  <body
    data-new-gr-c-s-loaded="14.1064.0"
    style="
      width: 100%;
                                ...
                                <tr>
                                  ...
                                  >
                                    <h1
                                      ...
                                      "
                                    >
                                      Você tem um novo<br />comentário no seu check-in!
                                    </h1>
                                  </td>
                                </tr>
                              </table>
                              ...
                              >
                                <tr>
                                  <td
                                    ...
                                    "
                                  >
                                    <p style="color: #798BB9; font-size: 14px;">Para responder, clique no botão abaixo:</p>
                                    <span
